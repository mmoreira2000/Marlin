...
#define STRING_CONFIG_H_AUTHOR "(Matheus Moreira, Anet A8-M)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BIQU_KFB_2
#endif
...
//#define PARKING_EXTRUDER
  ...
  #define HOTEND_OFFSET_Z { 0.0, 31.43 }              // Z-offsets of the two hotends. The first must be 0.
#endif
